...
- `brigade work review init/plan/run/runs/show/import-findings` for explicit local multi-harness code review producers, receipts, normalized findings, and `code-review` work inbox imports without automatic fixes or remote mutation.
